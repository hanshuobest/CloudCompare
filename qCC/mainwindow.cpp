...
ccGLWindow* MainWindow::new3DView()
{
	...
	//'echo' mode
	connect(view3D,	SIGNAL(mouseWheelRotated(float)),					this,		SLOT(echoMouseWheelRotate(float)));//鼠标滚轮信号槽
							...
							bool autoRedraw/*=true*/)
{
	...
	if (checkDimensions)
	{
		...
		PointCoordinateType diag = bBox.getDiagNorm();//对角线长度

		CCVector3d P = CCVector3d::fromArray(center.u);//中心点
